---
title: "Workshop: ESP-IDF a ESP32-C5 - Úkol 4"
...
V tomhle úkolu se podíváme, jak pracovat s [Non-Volatile-Storage (NVS)](https://docs.espressif.com/projects/esp-idf/en/release-v5.2/esp32/api-reference/storage/nvs_flash.html). Často se NVS říká "emulovaná EEPROM". ESP32-C5 ale žádnou EEPROM vestavěnou nemá, takže NVS používá paměť flash (tu samou, kam ukládáme i naši aplikaci).

> **Poznámka:** V tomhle úkolu použijeme ten samý projekt, který jsme používali v minulých dvou úkolech.
...
> **Poznámka:** Pokud vám nejde vyvolat *Partition Table Editor*, ověřte, že máte v konfiguraci nastavenou možnost *Partition Table -> Partition Table* na *Custom partition table CSV*.

Tabulku naplníme pomocí "Add New Row" tak, jak je vidno na obrázku:

![Obsah partition tabulky](assets/nvs-1.webp)
...
NVS editor otevřeme podobně: opět pomocí Ctrl + Shift + P otevřeme *Command Palette* a vybereme možnost *Open NVS partition editor*. Zdánlivě se nic nestane, ale nahoře uprostřed se otevře okno pro zadání jména souboru, kam budeme chtít NVS soubor uložit. Zvolíme třeba ``nvs.csv`` a stiskneme Enter. Otevře se nám okno podobné tomu níže:

![Obsah NVS tabulky](assets/nvs-2.webp)
...
idf_component_register(
    ...
    REQUIRES            esp_wifi esp_netif esp_event nvs_flash led_strip # optional, list the public requirements (component names)

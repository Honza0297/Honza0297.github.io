---
title: "Workshop: ESP-IDF a ESP32-C5 - Úkol 5"
...
ESP32-C5 samozřejmě tuhle možnost také podporuje. Můžete se s ní setkat v projektech, jakými je třeba náš [ESP RainMaker](https://rainmaker.espressif.com/).
...
```bash
idf.py create-project-from-example "espressif/network_provisioning^1.2.4:wifi_prov"
```
...
V kódu příkladu nebudeme nic měnit, ale: 
* ověříme, že máme správný target (ESP32-C5)
* vymažeme flash paměť (příkazem *Erase Flash*)

Potom už jen aplikaci sestavíme (build) a naflashujeme.
...
![](assets/provisioning-app-1.webp)
![](assets/provisioning-app-2.webp)
![](assets/provisioning-app-3.webp)
![](assets/provisioning-app-4.webp)
![](assets/provisioning-app-5.webp)
...
Když už víme, jak se jednoduše připojovat na Wi-Fi, pojďme se podívat na low-power techniky pro energeticky úsporné aplikace.

[Úkol 6: Low Power Core](../assignment-6)

...
K instalaci ESP-IDF použijeme náš nový instalátor [EIM](https://docs.espressif.com/projects/idf-im-ui/en/latest/) a rozšíření do VScode nainstalujeme podle návodu na [githubových stránkách ESP-IDF pluginu pro VS Code](https://github.com/espressif/vscode-esp-idf-extension?tab=readme-ov-file#how-to-use).

**Windows:**

### Instalace pro Windows

1. Nainstalujeme [EIM](https://dl.espressif.com/dl/eim/index.html)
    * Stiskneme klávesu Windows + R a do objevivšího okénka napíšeme powershell
    * Po zobrazení terminálu zadáme `winget install Espressif.eim`
2. Nainstalujeme ESP-IDF pomocí EIM
    * EIM spustíme z nabídky start nebo pomocí ikony na ploše
    * Na uvítací obrazovce klikneme na tlačítko `Start Installation` a poté `Custom installation` a necháme se průvodcem vést. Na stránce s výběrem verze poté zvolíme verzi IDF 5.5.4
    * Instalátor nám v průběhu nabídne i nainstalování gitu nebo pythonu pokud nám v počítači zatím chybí.
...
1. Nainstalujeme [EIM](https://dl.espressif.com/dl/eim/index.html)
    ...
    * Pokud si zvolíme CLI verzi, stačí nám teď zavolat `eim install -i v5.5.4`
    * Pokud jsme si vybrali GUI verzi, klikneme na uvítací obrazovce na tlačítko `Start Installation` a poté `Custom installation` a necháme se průvodcem vést. Na stránce s výběrem verze poté zvolíme verzi IDF 5.5.4

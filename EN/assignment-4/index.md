...
### Practical demonstration of NVS

In the demonstration, we will show how to prepare a *partition table*, NVS data file and change the code from the previous assignment so that Wi-Fi name and password are read from NVS.
...
![Partition table contents](./nvs0.png "NVS table contents")
...
![NVS table contents](./nvs1.png "NVS table contents")

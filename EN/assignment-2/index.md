...
## Assignment 2: Creating Projects and Components
...
If you want to create and publish your own component (for example for your specific sensor), we recommend that you watch the talk [DevCon23 - Developing, Publishing, and Maintaining Components for ESP-IDF](https://www.youtube.com/watch?v=D86gQ4knUnc) (in English).
...
![First step of creating a new project](./wizard0.png "Creating a new project. Serial port is not important, it can be changed later.")

![Second step of creating a new project](./wizard1.png "In the next step we choose what template to base our project on. We choose *get-started/hello_world* and create the project")
...
![Installing led_strip component 1](./ledstrip0.png "Component search")

![Installing led_strip component 2](./ledstrip1.png "Component installation")
...
Let there be light! When we can handle basic work with ESP and IDE, we are ready to connect to WiFi too!

[Assignment 3: Connecting to Wi-Fi](../assignment-3)